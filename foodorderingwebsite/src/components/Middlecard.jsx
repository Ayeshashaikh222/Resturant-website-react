...
function Middlecard() {
  return (
    <div className="w-full h-full mt-14">
      <div className="w-11/12 h-[600px] md:h-[370px] md:w-9/12 flex flex-col md:flex-row-reverse mx-auto ">
        <div className="md:w-1/2 h-96">
          <img
            ...
            className="w-full h-full object-center border-2 border-black rounded-xl rounded-b-none border-b-none"
          />
        </div>
