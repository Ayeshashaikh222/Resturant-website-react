    ...
    <div className="w-full h-full">
      <div className="relative flex flex-col w-full h-58 border mt-10 border-red-600">
        <img
          ...
          className="w-full object-conatiner md:object-cover h-[330px] md:h-[550px]"
        />
      ...
      <div className="md:hidden w-[484px] md:w-[600px] h-24 flex flex-col items-center justify-center text-center font-bold text-2xl md:text-4xl p-2 border-2 border-t-black border-b-black  bg-white">
        Our Locations & Hours
      </div>
    </div>
  );
